package com.zhen777.www.dynamic.datasource.mybatis.config;

import com.zhen777.www.dynamic.datasource.mybatis.constant.DBConstants;
...
@Configuration
@MapperScan(basePackages = {"com.zhen777.www.dynamic.datasource.mybatis.mapper.orders"},
...
public class MyBatisOrdersConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        // 设置 entity 所在包
        bean.setTypeAliasesPackage("com.zhen777.www.dynamic.datasource.mybatis.dataobject");
        // 设置 config 路径
